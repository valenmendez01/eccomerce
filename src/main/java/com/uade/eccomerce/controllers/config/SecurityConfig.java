    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(req -> req
                ...
                .requestMatchers(HttpMethod.POST, "/api/v1/asistente/preguntar").permitAll()
                ...
                .requestMatchers(HttpMethod.GET, "/productos/vendedor").hasAuthority(Rol.VENDEDOR.name())
                ...
                .requestMatchers(HttpMethod.GET, "/pedidos/comprador").hasAuthority(Rol.COMPRADOR.name())
